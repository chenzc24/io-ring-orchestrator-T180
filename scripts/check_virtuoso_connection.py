...
# -*- coding: utf-8 -*-
"""
Check Virtuoso Connection - T180 Skill Script

Enhanced version with full diagnostic capability.
...
# T180 shares bridge_utils with T28
...
def check_via_ramic_bridge() -> tuple[bool, list]:
    ...
    try:
        ...
        if result == "2":
            ...
            report.append("Virtuoso Connection: UNCERTAIN")
...
def check_environment() -> list:
    ...
    if rb_host == "not set":
        report.append("  Not configured (required for RAMIC Bridge)")
    report.append("")
